...
public class TicketDetailQueryAdapter implements TicketDetailQueryRepository {
    ...
    public Optional<TicketDetailDto> findTicketDetailById(Long ticketId) {
        ...
        String ticketTypeName = ticket.getTicketType() != null ? ticket.getTicketType().getTypeName() : "Unknown Type";
        ...
        remoteRequestRepository.findById(ticketId).ifPresent(rr -> builder.remoteRequest(RemoteRequestDto.builder()
        ...
        // Fetch collections separately to avoid Cartesian Product (2 queries)
